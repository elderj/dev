...
const Fitbit = () => (
  <div className="floating-content">
      ...
      <ul>
        ...
        <li className="portfolioListItem">
          <div className="tooltip">
            ...
            </a>             <span className="tootipFitbitImage">
              <img className="linkLogoImage" alt="LinkedIn logo" src={instagramLogo} />
            </span>
          </div>
        </li>
    ...
    <p className="quicksand-text blurb">
      Fitbit uses a 3rd party system called "K-Pay" to handle purchases of clockfaces and apps for their smartwatches.
      If you are having trouble installing or reinstalling a clockface, please <Link to="/contact">contact me</Link> and I will walk you through any challenges you may have.
      <br />
      <br />
