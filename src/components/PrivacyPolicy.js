...
const PrivacyPolicy = () => (
  <div className="floating-content">
    ...
    <p>
      At Elder Design Concepts, accessible from http://www.elderj.com, one of
      ...
      Elder Design Concepts and how we use it.
    </p>
    ...
    <p>
      Elder Design Concepts follows a standard procedure of using log files.
    ...
    <p>
      Like any other website, Elder Design Concepts uses 'cookies'. These
    ...
    <p>
      ...
      advertising partners of Elder Design Concepts.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Elder Design Concepts, which are
    ...
    <p>
      Note that Elder Design Concepts has no access to or control over these
    ...
    <p>
      Elder Design Concepts's Privacy Policy does not apply to other advertisers
    ...
    <p>
      Elder Design Concepts does not knowingly collect any Personal Identifiable
    ...
    <p>
      ...
      and/or collect in Elder Design Concepts. This policy is not applicable to
