...
const TriangleSkillGameTOS = () => (
  <div className="floating-content">
    <Header />
    <NavBar />
    <h3 className="quicksand-text blurb">
      Triangle Skill Game Terms &amp; Conditions
      <br />
    </h3>
    <p className="quicksand-text blurb">
      ...
      <p>
        ...
        phone’s security features and it could mean that the Triangle Skill Game
...
export default TriangleSkillGameTOS;
