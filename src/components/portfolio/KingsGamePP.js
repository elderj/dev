...
const KingsGamePP = () => (
  <div className="floating-content">
    ...
    <h3 className="quicksand-text blurb">
      Kings Drinking Game Privacy Policy
      <br />
    </h3>
    <p className="quicksand-text blurb">
      <p>
        Elder Design Concepts built the Kings Drinking Game app as an Ad
      ...
      <p>
        ...
        , which is accessible at Kings Drinking Game unless otherwise defined in
        this Privacy Policy.
      </p>{" "}
      <p>
