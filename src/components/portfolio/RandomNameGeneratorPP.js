...
const RandomNameGeneratorPP = () => (
  <div className="floating-content">
    <Header />
    <NavBar />
    <h3 className="quicksand-text blurb">
      Random Name Generator Privacy Policy
      <br />
    </h3>
    <p className="quicksand-text blurb">
      <p>
        Elder Design Concepts built the Random Name Generator app as an Ad
        Supported app. This SERVICE is provided by Elder Design Concepts at no
      ...
      <p>
        ...
        , which are accessible at Random Name Generator unless otherwise defined
      ...
      <p>This policy is effective as of 2021-11-30</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at ElderDesignConcepts@gmail.com.
      </p>{" "}
      <p>
...
export default RandomNameGeneratorPP;
