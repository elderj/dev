...
const KingsGameTOS = () => (
  <div className="floating-content">
    ...
    <h3 className="quicksand-text blurb">GOVERNING LAW</h3>
    ...
    <p className="quicksand-text blurb">
      ...
      [jurisdiction]. If you have any questions or concerns about these Terms,
      please contact us at [contact email address]. By clicking "I Agree" or
      using the App, you acknowledge that you have read, understood, and agree
      to these Terms.
    </p>
