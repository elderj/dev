...
const TriangleSkillGamePP = () => (
  <div className="floating-content">
    <Header />
    <NavBar />
    <h3 className="quicksand-text blurb">
      Triangle Skill Game Privacy Policy
      <br />
    </h3>
    <p className="quicksand-text blurb">
      <p>
        Elder Design Concepts built the Triangle Skill Game app as an Ad
...
export default TriangleSkillGamePP;
