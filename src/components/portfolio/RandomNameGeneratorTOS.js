...
const RandomNameGeneratorTOS = () => (
  <div className="floating-content">
    <Header />
    <NavBar />
    <h3 className="quicksand-text blurb">
      Random Name Generator Terms &amp; Conditions
      <br />
    </h3>
    <p className="quicksand-text blurb">
      <p>
        ...
        other intellectual property rights related to it, still belong to Elder
        Design Concepts.
      </p>{" "}
      <p>
      ...
      <p>
        The Random Name Generator app stores and processes personal data that
        ...
        phone’s security features and it could mean that the Random Name
        Generator app won’t work properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Elder Design
        ...
        Elder Design Concepts cannot take responsibility for the app not working
        at full functionality if you don’t have access to Wi-Fi, and you don’t
      ...
      <p>These terms and conditions are effective as of 2021-11-30</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at ElderDesignConcepts@gmail.com.
      </p>{" "}
      <p>
...
export default RandomNameGeneratorTOS;
